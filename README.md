...
## 最新版本 v1.0.16-review-health-export

- 新增「牌局檢討」：牌局中與結束後會摘要合約方目標、已得墩數、剩餘墩數、是否已達標或已無法成約。
- 新增「牌局健康檢查」：即時檢查 52 張牌是否唯一、座位是否齊全、目前階段與輪到者是否合理。
- 新增下載完整牌譜 TXT、複製牌局檢討，方便賽後檢討、分享與回報問題。
