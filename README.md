...
## 最新版本 v1.0.15-wait-countdown-offline-control

- 新增「輪到你」醒目提示列；輪到玩家叫牌或出牌時會顯示操作摘要，並依音效/震動設定提醒。
- 新增教練建議：輪到玩家時會提示建議叫品或建議出牌，也可一鍵套用。
- 房主可在牌局中直接調整節奏，不必回到大廳；牌局中也可直接複製邀請連結。
