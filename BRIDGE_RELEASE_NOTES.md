## bridge-v1.0.24.9-home-simplified

- 首頁重新整理成四大區塊：單人遊戲、多人遊戲、說明、其他設定。
- 單人遊戲保留常用設定與快速開始，預設仍為變體模式：四手暗牌。
- 多人遊戲只保留暱稱、房號、連線、建立、加入、觀戰等必要入口，房間規則改到大廳內調整。
- 說明區集中放置新手導覽、玩法摘要、教學、本版更新、正式版測試與公開狀態。
- 其他設定集中收納主題、提示、音效、震動、手機手感、統計、維護、AI 測試與 Firebase 部署檢查。
- 延續 v1.0.24.8 的 AI 叫牌防呆修正。
